#ifndef GRAPHICSREMOTEVIEW_H
#define GRAPHICSREMOTEVIEW_H
...
class KDE_EXPORT GraphicsRemoteView : public QWidget
{
    Q_OBJECT
...
public:
    ...
    * by @ref GraphicsRemoteView::status().
    *
    ...
    *
    * @ref GraphicsRemoteView::setStatus() will follow this rules for you.
...
signals:
     ...
     * @param s the new status
        */
    void statusChanged(GraphicsRemoteView::RemoteStatus s);
...
protected:
    GraphicsRemoteView(QWidget *parent = 0);
